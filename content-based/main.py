...
if __name__ == '__main__':
    p = ap.ArgumentParser()
    p.add_argument("-g", "--groundtruth", help="File containing the labels for all messages.", type = str, default="/home/ncecillon/Documents/groundtruth_attack.csv")
    p.add_argument("-md", "--messagesdir", help="Directory containing all conversation files.", type = str, default="/home/ncecillon/Documents/csv")
